...
import time
import ssl
ssl._create_default_https_context = ssl._create_unverified_context  # Bỏ xác minh SSL toàn cục
                ...
                if not os.path.exists(output_path):
                    ydl_opts = {
                        ...
                        'nocheckcertificate': True,
                         'check_certificate': False  # 👈 thêm dòng này để tránh lỗi SSL thật sự
                    }
